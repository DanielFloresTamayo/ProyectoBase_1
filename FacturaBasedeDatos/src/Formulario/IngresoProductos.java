...
public class IngresoProductos extends javax.swing.JFrame {
    ...
    void cargar(String valor) {
      String cons="select * from productos WHERE CONCAT (descripcion,'',precio) LIKE '%"+valor+"%'";
    ...
    private void btnguardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar1ActionPerformed
        ...
        sql="INSERT INTO productos (cod_pro,descripcion,precio,Stock) VALUES (?,?,?,?)";
        try {
    ...
    private void btnactualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizar1ActionPerformed
        // TODO add your handling code here:
        String sql="UPDATE productos SET precio = '"+Integer.parseInt(txtpre.getText())+"',descripcion ='"+txtdes.getText()+"',Stock = '"+txtstock.getText()+"' WHERE cod_pro = '"+txtcod.getText()+"'";
        try {
            PreparedStatement pst = cn.prepareStatement(sql);
            pst.executeUpdate();
