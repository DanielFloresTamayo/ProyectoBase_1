...
public class FrmIngresoClientes extends javax.swing.JFrame {
    ...
    btnactualizar.setEnabled(false);
     ...
     String mostrar="SELECT * FROM clientes WHERE CONCAT(cod_cli,nom_cli,apel_cli,ruc_cli) LIKE '%"+valor+"%'";
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        sql="INSERT INTO clientes (cod_cli,nom_cli,apel_cli,sexo_cli,tel_cli,ruc_cli,email_cli,dir_cli) VALUES (?,?,?,?,?,?,?,?)";
        try {
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        try {
            PreparedStatement pst = cn.prepareStatement("UPDATE clientes SET nom_cli='"
                +txtnom.getText()+ "',apel_cli='"
                +txtape.getText()+ "',sexo_cli='"
                //+cmbsexo.getSelectedItem()+ "',dni_cli='"
                +txtid.getText()+ "',tel_cli='"
