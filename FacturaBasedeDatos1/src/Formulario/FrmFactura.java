...
public class FrmFactura extends javax.swing.JFrame {
    ...
    void descontarstock(String codi,String can)
    {
       ...
       String cap="";
       int desfinal;
       String consul="SELECT * FROM productos1 WHERE  cod_pro='"+codi+"'";
        try {
        ...
        String modi="UPDATE productos1 SET Stock='"+desfinal+"' WHERE cod_pro = '"+codi+"'";
        try {
     ...
     void numeros()
     {
        ...
        String num="";
        String c="";
         String SQL="select max(num_fac) from factura1";
    ...
    void factura(){
       String InsertarSQL="INSERT INTO factura1 (num_fac,cod_cli,subtotal,igv,total,fec_fac) VALUES (?,?,?,?,?,?,?)";
    ...
    void detallefactura(){
        for(int i=0;i<jtbdet.getRowCount();i++)
        {
        String InsertarSQL="INSERT INTO detallefactura1(num_fac,cod_pro,des_pro,cant_pro,pre_unit,pre_tot) VALUES (?,?,?,?,?,?)";
        String numfac=txtnumfac.getText();
